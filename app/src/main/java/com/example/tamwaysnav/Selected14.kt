...
class Selected14 : AppCompatActivity(), UsersAdapter.ClickListener {
    ...
    override fun clickedItem(userModel: UserModel) {
        ...
        when(userModel.username){
            "ABB Canteen"->
                startActivity(Intent(this@Selected14, Selected13tob1e::class.java))
            "ABB 1st Floor"->
                startActivity(Intent(this@Selected14, Selected13tob1a::class.java))
            "ABB 2nd Floor (Room 201 - 208)"->
                startActivity(Intent(this@Selected14, Selected13tob2a::class.java))
            "ABB 3rd Floor (Room 301 - 307)"->
                startActivity(Intent(this@Selected14, Selected13tob3a::class.java))
            "ABB 4th Floor (Room 401 - 407)"->
                startActivity(Intent(this@Selected14, Selected13tob5a::class.java))
            "ABB 6th Floor (Room 601 - 607)"->
                startActivity(Intent(this@Selected14, Selected13tob6a::class.java))
