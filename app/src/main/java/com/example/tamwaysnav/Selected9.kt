...
class Selected9 : AppCompatActivity(), UsersAdapter.ClickListener {

    private lateinit var rvUsers: RecyclerView
    private lateinit var usersAdapter9: UsersAdapter;
    private lateinit var toolbar: Toolbar;

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_selected9)
        initData();
    }
    ...
    private fun initRecyclerView(){
        ...
        usersAdapter9 = UsersAdapter(this);
        rvUsers.adapter = usersAdapter9;
        showData();
    ...
    private fun showData(){
        usersAdapter9.setData(populateUsers())
    }
    ...
    override fun clickedItem(userModel: UserModel) {
        ...
        when(userModel.username){
            "NB Gate"->
                startActivity(Intent(this@Selected9, Selected9to1o::class.java))
            "NB Finance"->
                startActivity(Intent(this@Selected9, Selected9to2g::class.java))
            "NB Registrar"->
                startActivity(Intent(this@Selected9, Selected9to2m::class.java))
            "NB OGLH"->
                startActivity(Intent(this@Selected9, Selected9to4e::class.java))
            "NB SHS Faculty Room"->
            ...
            "NB 2nd Floor (Room 201 - 207)"->
                startActivity(Intent(this@Selected9, Selected9to2a::class.java))
            "NB 3rd Floor (Room 301 - 309)"->
                startActivity(Intent(this@Selected9, Selected9to3a::class.java))
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener{
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                usersAdapter9.filter.filter(newText)
                return true;
            }
